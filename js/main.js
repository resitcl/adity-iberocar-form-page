...
app.common = {
  init: function() {
    $("[data-next-form-1]").click(function() {
      app.loader["in"]($(".section__loader"));
      return setTimeout(function() {
        app.loader.out($(".section__loader"));
        $(".section__form__step--1").removeClass("section__form__step--show");
        $(".section__form__step--2").addClass("section__form__step--show");
        $(".section__step--2").addClass("current");
        return $(".section__steps").addClass("section__steps--2");
      }, 1000);
    });
    $("[data-prev-form-1]").click(function() {
      app.loader["in"]($(".section__loader"));
      return setTimeout(function() {
        app.loader.out($(".section__loader"));
        $(".section__form__step--2").removeClass("section__form__step--show");
        $(".section__form__step--1").addClass("section__form__step--show");
        $(".section__step--2").removeClass("current");
        return $(".section__steps").removeClass("section__steps--2");
      }, 1000);
    });
    $("[data-prev-form-2]").click(function() {
      app.loader["in"]($(".section__loader"));
      return setTimeout(function() {
        app.loader.out($(".section__loader"));
        $(".section__form__step--3").removeClass("section__form__step--show");
        $(".section__form__step--2").addClass("section__form__step--show");
        $(".section__step--3").removeClass("current");
        return $(".section__steps").removeClass("section__steps--3");
      }, 1000);
    });
    $("[data-next-form-2]").click(function() {
      app.loader["in"]($(".section__loader"));
      return setTimeout(function() {
        app.loader.out($(".section__loader"));
        $(".section__form__step--2").removeClass("section__form__step--show");
        $(".section__form__step--3").addClass("section__form__step--show");
        $(".section__step--3").addClass("current");
        return $(".section__steps").addClass("section__steps--3");
      }, 1000);
    });
    $("[data-next-form-2]").click(function() {
      $(".section__form__step").removeClass("section__form__step--show");
      return $(".section__form__step--2").addClass("section__form__step--show");
    });
    return $(".section__radio input").change(function() {
      if ($(this).is(':checked')) {
        $(".section__radio").removeClass("checked");
        return $(this).parents(".section__radio").addClass("checked");
      }
    });
  }
};
...
app.loader = {
  ...
  html: function() {
    return '' + '<div class="loader">' + '<svg viewBox="25 25 50 50">' + '	<circle cx="50" cy="50" r="20"></circle>' + '</svg>' + '<span>Cargando</span>' + '</div>';
  },
  "in": function(element) {
    if (!element) {
      element = $("body");
